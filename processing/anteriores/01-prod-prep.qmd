...
subtitle: "Housing wealth and social cohesion: Evidence from Chile"
...
#### Descriptive analysis of housing variable
...
df_study1 %>% 
  group_by(ola) %>% 
  summarise(m = mean(area_sd_uf, na.rm = T))

psych::describeBy(df_study1$area_sd_uf, df_study1$ola)
```
